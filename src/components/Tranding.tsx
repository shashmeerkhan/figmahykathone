...
import f4 from "../../public/top/box for image (1).png";
import f3 from "../../public/top/box for image.png";
import f2 from "../../public/top/image 1171.png";
import f1 from "../../public/top/image 31.png";
...
const Tranding: React.FC = () => {
  return (<>
    <div className="text-bolder text-[50px] text-center">Tranding Products</div>
