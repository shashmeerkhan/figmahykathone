            ...
            <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div className="lg:col-span-3 text-center">
                    <div className="lg:h-[450px] p-4 relative before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                        <Image src="https://readymadeui.com/images/sunglass7.webp" alt="Product" className="lg:w-11/12 w-full h-full rounded object-contain object-top" />
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4 mx-auto mt-4">
                        <div className="cursor-pointer p-1 relative before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <Image src="https://readymadeui.com/images/sunglass1.webp" alt="Product2" className="w-20 h-16 object-contain" />
                        </div>
                        <div className="cursor-pointer p-1 relative before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <Image src="https://readymadeui.com/images/sunglass2.webp" alt="Product3" className="w-20 h-16 object-contain" />
                        </div>
                        <div className="cursor-pointer p-1 relative before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <Image src="https://readymadeui.com/images/sunglass3.webp" alt="Product4" className="w-20 h-16 object-contain" />
                        </div>
                        <div className="cursor-pointer p-1 relative before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <Image src="https://readymadeui.com/images/sunglass5.webp" alt="Product5" className="w-20 h-16 object-contain" />
                        </div>
                        <div className="cursor-pointer p-1 relative before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <Image src="https://readymadeui.com/images/sunglass6.webp" alt="Product6" className="w-20 h-16 object-contain" />
                        </div>
                        <div className="cursor-pointer p-1 relative before:absolute before:inset-0 before:bg-black before:opacity-20 before:rounded">
                            <Image src="https://readymadeui.com/images/sunglass7.webp" alt="Product7" className="w-20 h-16 object-contain" />
                        </div>
                    </div>
                </div>
